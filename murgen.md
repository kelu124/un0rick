...
# **BEWARE: This project has been deprecated since the arrival of the [module project](modules) in 2018**
...
![A nice image](https://github.com/kelu124/murgen-dev-kit/raw/master/worklog/Images/Session_7/MurgenComparative.png)
...
![PhysicalSpace](https://github.com/kelu124/murgen-dev-kit/raw/master/worklog/Images/Session_7/PhysicalSpace.png)
...
- [Session 1](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_1.md) : Powering the board, power use, first (bad) trigging and echoes (06 March 2016)
- [Session 2](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_2.md) : Non-controlled pulsing, inverters, better echoes (11 March 2016)
- [Session 3](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_3.md) : Getting controlled pulsing, but width not controlled (15 March 2016)
- [Session 4](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_4.md) : Width of the pulses is getting controlled =) (19 March 2016)
- [Session 4b](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_4b.md) : Simple data visualisation with BitScope (19 March 2016)
- [Session 5](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_5.md) : moving the transducer to get the first image (20 March 2016)
- [Session 6](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_6.md) : ***Getting a clinically usable image*** (28 March 2016)
- [Session 7](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_7.md) : Getting cleaner images - code improvements  (3 April 2016)
- [Session 8](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_8.md) : Comparing acquisition speeds (3 May 2016)
- [Session 9](https://github.com/kelu124/murgen-dev-kit/blob/master/worklog/Session_9.md) : Playing with ATL10PV (3 July 2016)
- [A more complete hardware ReadMe](https://github.com/kelu124/murgen-dev-kit/blob/master/hardware/Readme.md) : Information, and more, with a focus on the electronic part of the project
- [A more complete software ReadMe](https://github.com/kelu124/murgen-dev-kit/blob/master/software/Readme.md) : Information, and more, with a focus on the code part of the project (arduino, python, and such)
...
The project's phase is coming to an end! Some ideas, lessons, stuff at our [NextSteps.md](https://github.com/kelu124/murgen-dev-kit/blob/master/NextSteps.md)
...
* There are 5 big projects listed on the [NextSteps.md](https://github.com/kelu124/murgen-dev-kit/blob/master/NextSteps.md) document.
...
[Source](https://github.com/kelu124/murgen-dev-kit/blob/master/Readme.md)
